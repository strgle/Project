 ...
 */
@Controller
@RequestMapping("statistics/jbxj/xunjian")
public class Xunjian {
	 ...
	 */
	@RequestMapping("{matc}")
	public String index(@PathVariable("matc") String matc, String endDate,String endTime,Model model){
		...
		return "statistics/jbxj/xunjian/index";
	}
	
	@RequestMapping(value="remark",produces = "application/json;charset=UTF-8")
	@ResponseBody
	public String remark(String id,String value) {
		String sql = "update JBXJ_XJ_REPORT set remark = ? where id = ? ";
