...
<div class="left-side">	
	...
	<div class="panel panel-default" style="margin-right: -2PX;">
		...
		<div class="panel-body" style="padding-top: 0px;padding-bottom: 0px;" >
		   	<div id="treeContent" style="overflow-y: scroll;width: 215px;padding-right: 2px;">
...
function selectItem(node){
	...
	$("#contentDetail").attr("src","${pageContext.request.contextPath}/lims/dataLedger/prodMes/monitorInfo?"+params);
}
