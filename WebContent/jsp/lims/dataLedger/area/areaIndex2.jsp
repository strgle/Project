...
<div class="left-side">	
	...
	<div class="panel panel-default" style="margin-right: -2PX;">
		<div class="panel-heading">车间装置列表</div>
...
function selectItem(node){
	...
	//$("#contentDetail").attr("src","${pageContext.request.contextPath}/lims/dataLedger/area/detail?"+params);
	$("#contentDetail").attr("src","${pageContext.request.contextPath}/lims/dataLedger/area/detail2?"+params);
}
