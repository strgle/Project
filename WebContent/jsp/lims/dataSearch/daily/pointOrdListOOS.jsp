...
<div class="panel panel-default" style="margin-bottom: 0px;">
	...
	<form class="form-inline" action="${pageContext.request.contextPath}/lims/dataSearch/daily/samplelist">
...
function showDetail(ordno,obj){
	...
	layer.open({
		  ...
		  ,area: ['100%', '100%']
		  ,title: '检测结果'
		  ,content: '${pageContext.request.contextPath}/lims/dataSearch/daily/ordDetailOOS?ordNo='+ordno
	});  
}
