...
function query(){
	...
	$('#tree1').tree({
		url:"${pageContext.request.contextPath}/api/lims/areaPlants/reportPlantsDone",
		data:param,
...
function selectFolder(node){
	...
	//var url = "${pageContext.request.contextPath}/lims/dataSearch/report/reportListOOS";
	if(node.type=="area"){
	...
	$("#ordList").attr("src","${pageContext.request.contextPath}/lims/dataSearch/report/reportListDone?"+params);   
}
