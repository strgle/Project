...
function query(){
	...
	$('#tree1').tree({
		url:"${pageContext.request.contextPath}/api/lims/areaPlants/reportPlantsApprove",
		data:param,
...
function selectFolder(node){
	...
	var url = "${pageContext.request.contextPath}/lims/dataSearch/report/reportListApprove";
	if(node.type=="area"){
	...
	$("#ordList").attr("src","${pageContext.request.contextPath}/lims/dataSearch/report/reportListApprove?"+params);   
}
