...
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<div class="panel-tools" style="top:8px;">
            <label class="btn btn-xs btn-danger" onclick="check('${ord.ordno}')">异常检查</label>
...
<script type="text/javascript">
 ...
 function check(ordno){
	 layer.open({
		  type: 2 //Page层类型
		  ,area: ['100%', '100%']
		  ,title: '检测结果'
		  ,content: '${pageContext.request.contextPath}/lims/dataSearch/daily/checkOOS?ordNo='+ordno
	 });  
 }
