...
function query(){
	...
	$('#tree1').tree({
		url:"${pageContext.request.contextPath}/api/lims/areaPlants/reportPlantsOOS",
		data:param,
...
function selectFolder(node){
	...
	$("#ordList").attr("src","${pageContext.request.contextPath}/lims/dataSearch/report/reportListOOS?"+params);   
}
