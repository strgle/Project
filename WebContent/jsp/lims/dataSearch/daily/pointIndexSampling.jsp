...
function selectFolder(node){
	var url = "${pageContext.request.contextPath}/lims/dataSearch/daily/samplelistSampling";
	//获取车间、装置
	if(node.type=="area"){
...
function query(){
	...
	$('#tree1').tree({
		url:"${pageContext.request.contextPath}/api/lims/areaPlants/pointsSampling",
		data:param,
