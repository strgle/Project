...
<table class="table">
			<tr>
				<th style="background-color: #fff;padding: 15px;">
					<form action="${pageContext.request.contextPath}/statistics/jbxj/rate/month/${matcode}" method="post" id="form">
					<input type="hidden" name="startDate" value="${startDate}"/>
					<input type="hidden" name="endDate" value="${endDate}"/>
					<input type="hidden" name="flag" value="" id="flag">
					</form>
					<label id="weekdate" style="background-color:#009688;padding: 5px 20px;color:#FFF;margin-right:10px;cursor: pointer;" onclick="prev()">上月</label>
					<label id="weekdate" style="font-size:18px;background-color:#009688;padding: 5px 20px;color:#FFF;">${startDate} - ${endDate}</label>
					<label id="weekdate" style="background-color:#009688;padding: 5px 20px;color:#FFF;margin-left:10px;cursor: pointer;" onclick="next()">下月</label>
