...
<div class="panel panel-default" style="margin-bottom: 0px;">
	<div class="panel-body" style="padding:10px 20px;text-align: right;">
				<label style="font-weight: bold;color: #F00;">关键指标用于质量考核功能。</label>
...
<div class="panel panel-default" style="margin-bottom:0px;padding: 0px;">
	...
	<table class="table table-bordered table-condensed">
		...
		<c:forEach items="${keyPoints}" var="v" varStatus="status">
		<tr data-id="${v.id }">
			<td>
...
function forAdd(){
	window.location.href= "${pageContext.request.contextPath}/statistics/jbxj/processSetting/forAdd/${parentId}"; 
}

function forUpdate(id){
	window.location.href = "${pageContext.request.contextPath}/statistics/jbxj/processSetting/forUpdate/"+id; 
	
}

function del(id){
	var url= "${pageContext.request.contextPath}/statistics/jbxj/processSetting/del/"+id;
	$.ajax({
		type: 'POST',
		url:url,
		dataType: "json",
...
function updateValue(id,value){
	...
	var urls="${pageContext.request.contextPath}/statistics/jbxj/processSetting/sort";
	$.ajax({
		url:urls,
		data:params,
		type: 'POST',
