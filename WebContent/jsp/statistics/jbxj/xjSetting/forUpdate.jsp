...
<form class="layui-form layui-form-pane" action="${pageContext.request.contextPath}/statistics/jbxj/xunjianSetting/update" id="form" method="post">
  <input type="hidden" name="id" value="${keyPoint.id}"/>
  <input type="hidden" name="matType" value="${keyPoint.matType}"/>
  <div class="layui-form-item" pane>
   ...
   <div class="layui-form-item" pane>
    ...
    <div class="layui-input-block">
        <input type="text" name="area" required  lay-verify="required" placeholder="车间" autocomplete="off" class="layui-input" value="${keyPoint.area }">
    </div>
  </div>
   ...
   <div class="layui-form-item" pane>
    ...
    <div class="layui-input-block">
        <input type="text" name="plant" required  lay-verify="required" placeholder="采样点" autocomplete="off" class="layui-input" value="${keyPoint.plant }">
    </div>
  </div>
